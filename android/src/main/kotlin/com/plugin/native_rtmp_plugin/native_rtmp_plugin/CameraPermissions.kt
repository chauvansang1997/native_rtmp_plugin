...
import com.plugin.native_rtmp_plugin.native_rtmp_plugin.PermissionStuff
...
class CameraPermissions {
    ...
    fun requestPermissions(
        ...
        if (!hasCameraPermission(activity) || enableAudio && !hasAudioPermission(activity) || !hasWriteExternalStoragePermission(
                activity
            ) || !hasWakeLockPermission(activity)
        ) {
